...
try {
  ...
  run('pnpm', ['exec', 'node', '--import', 'tsx', '--test', 'test/speed-timing-postgres.integration.test.ts'], {
    APP_ENV: 'test', AUTH_MODE: 'dev_stub', DATABASE_URL: schemaDatabaseUrl,
    ENABLE_DEV_AUTH: 'true', ENABLE_DEV_ROUTES: 'true', NODE_ENV: 'test',
    RUN_SPEED_TIMING_POSTGRES_INTEGRATION: '1', STANDARD_1V1_QUEUE_ENABLED: 'true', SPEED_1V1_QUEUE_ENABLED: 'true',
  });
} catch (error) {
  exitCode = 1;
